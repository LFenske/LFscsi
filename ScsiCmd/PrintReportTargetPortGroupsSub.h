 ...
 */
#ifndef __PrintReportTargetPortGroupsSub_h
#define __PrintReportTargetPortGroupsSub_h

#include "common.h"

void PrintReportTargetPortGroupsSub(VECTOR dat);

#endif /* __PrintReportTargetPortGroupsSub_h */
